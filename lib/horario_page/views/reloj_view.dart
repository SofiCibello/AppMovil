...
class RelojView extends StatefulWidget {
  final double size;

  const RelojView({Key key, this.size}) : super(key: key);

  @override
  _RelojViewState createState() => _RelojViewState();
}

class _RelojViewState extends State<RelojView> {
  @override
  void initState() {
...
class RelojPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    var fillBrush = Paint()..color = Colors.black45;
    ...
    var centerDotBrush = Paint()..color = Colors.black87;
    ...
    var dashBrush = Paint() // marcas alrededor del reloj(dibujo)
